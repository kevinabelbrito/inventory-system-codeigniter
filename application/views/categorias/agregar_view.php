...
<div class="modal fade" id="ModalAgregar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<?= form_open('categorias/agregar', array('id' => 'categoriasForm')) ?>
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="myModalLabel">Agregar un nueva categoría</h4>
			</div>
			<div class="modal-body bg-info">
				<div class="row">
					...
					<div class="alert alert-success" id="success">
						<strong><span class="glyphicon glyphicon-ok-sign"></span> ¡Excelente!</strong> La categoría ha sido agregado con éxito
					</div>
...
<script>
	$(function(){
		...
		$("#categoriasForm").submit(function(){
			var datosForm = $("#categoriasForm").serialize();
			$.post("<?= base_url() ?>categorias/agregar", datosForm, procesar).error(procesarError);
			return false;
		});
