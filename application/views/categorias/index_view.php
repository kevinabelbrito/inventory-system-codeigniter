<div class="content-layout">
    <div class="content-layout-row">
	    <div class="layout-cell" style="width: 40%" >
	        <?= form_open('categorias/', array('class' => 'search', 'id' => 'busquedaForm', 'method' => 'get')) ?>
			<?= form_input('campo', $campo, array('id' => 'campo', 'placeholder' => 'Descripción de la categoría')) ?><a class="search-button" href="#" onclick="javascript:jQuery(this).parents('form').submit();"><span class="search-button-text">Buscar</span></a>
			<?= form_close() ?>
	    </div>
    ...
    <div class="content-layout-row">
	    <div class="layout-cell" style="width: 100%" >
			...
			<table style="margin: auto;">
				...
				$this->load->view('categorias/editar_view', $data);
				?>
				<!--Modal Eliminar-->
				<?php
				$data = array('id' => $cat->id, 'descripcion' => $cat->descripcion);
				$this->load->view('categorias/eliminar_view', $data);
				?>
				<?php endforeach ?>
			</table>
			</div>
			...
			<?php
			$this->load->view('categorias/agregar_view');
			?>
	    </div>
    </div>
</div>