...
<div class="modal fade" id="ModalEliminar<?= $id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			¿Estas realmente seguro de querer eliminar este producto del inventario? una vez procesada esta accion no habrá vuelta atrás.
			</div>
			<div class="modal-footer">
				<a href="<?= base_url() ?>productos/eliminar/<?= $id ?>" class="button">Aceptar</a>
